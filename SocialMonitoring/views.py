from .serializers import (PapSerailzer,papviewserialzer,ConstructionSiteDetailsViewSerializer, constructionSiteSerializer, LabourCampDetailSerializer, LabourCampDetailViewSerializer)
...
from .models import  Compensation , PAP , Rehabilation , ConstructionSiteDetails , LabourCamp
...
#     def post(self, request):
#         queryset = testserialzier(data =request.data)
